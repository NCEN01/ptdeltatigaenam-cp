    ...
    <section class="section-sm bg-white">
        <div class="container">
            <div class="max-w-3xl" data-aos="fade-up">
                ...
                <p class="mt-5 max-w-2xl text-pretty leading-relaxed text-navy-500">
                    {{ $id
            ...
            <div class="mt-10 grid gap-6 sm:grid-cols-3" data-aos="fade-up" data-aos-delay="80">
                @foreach ($trust as $item)
                    <div class="group rounded-2xl border border-navy-100 bg-white p-6 shadow-card transition-all duration-300 hover:-translate-y-1 hover:shadow-lift">
                        ...
                        <p class="mt-2 text-sm leading-relaxed text-navy-500">{{ $item['d'] }}</p>
                    </div>
                @endforeach
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="mt-10 flex flex-col items-center justify-between gap-5 rounded-3xl border border-navy-100 bg-white p-7 shadow-card md:flex-row md:p-8" data-aos="fade-up">
                <div>
                    ...
                    <p class="mt-1.5 text-sm leading-relaxed text-navy-500">{{ $id ? 'Ikuti program sertifikasi kompetensi resmi bersama PT Delta Tiga Enam.' : 'Join an official competency certification program with PT Delta Tiga Enam.' }}</p>
                </div>
